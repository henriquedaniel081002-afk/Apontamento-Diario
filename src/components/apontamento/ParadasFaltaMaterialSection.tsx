  ...
  return (
    <Surface as="section" className="record-industrial overflow-hidden" aria-labelledby="material-title">
      <div className="flex items-start gap-3 border-b border-[var(--border-subtle)] p-5 sm:p-6">
        ...
        <div><p className="mb-1 text-xs font-semibold uppercase tracking-[0.14em] text-amber-300">Ocorrência opcional</p><h2 id="material-title" className="text-lg font-bold text-[var(--text-primary)]">Parada por Falta de Material</h2><p className="mt-1 text-sm leading-6 text-[var(--text-secondary)]">Adicione quantas paradas forem necessárias. Os campos podem ser preenchidos parcialmente e complementados depois.</p></div>
      </div>

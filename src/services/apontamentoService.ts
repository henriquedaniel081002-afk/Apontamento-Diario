...
export const apontamentoService={
  ...
  async save(apontamentoData:Omit<Apontamento,'id'|'createdAt'|'updatedAt'>):Promise<Apontamento>{return api('/api/apontamentos',{method:'POST',body:JSON.stringify(apontamentoData)});},
